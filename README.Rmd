...
<!-- badges: end -->
Repositori ini merupakan [RStudio Project](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects) [lihat @wickham_r_2017, Bab 8] untuk makalah yang sedang menjalani proses "tinjauan sejawat" [*peer-review*] di jurnal [*Linguistik Indonesia*](http://ojs.linguistik-indonesia.org/index.php/linguistik_indonesia)) [untuk naskah *pre-print*, lihat @Rajeg2020]. Struktur R Project ini berisi data dan [R Markdown Notebook](https://rmarkdown.rstudio.com/lesson-10.html).
